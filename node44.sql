...
SELECT user_id, COUNT(*) AS people_like FROM like_res
GROUP BY user_id
ORDER BY people_like DESC
LIMIT 5;

#Tìm 2 nhà hàng có lượt like nhiều nhất
SELECT res_id, COUNT(*) AS res_like FROM like_res
GROUP BY res_id
...
SELECT user_id, COUNT(*) AS people_order FROM orders
GROUP BY user_id
...
LEFT JOIN like_res AS l ON o.food_id = l.user_id
LEFT JOIN rate_res AS r ON o.user_id = r.user_id
